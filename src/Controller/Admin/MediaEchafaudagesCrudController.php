...
class MediaEchafaudagesCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return MediaEchafaudages::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        AssociationField::new('echafaudage')
            ->setLabel('Echafaudage'),
